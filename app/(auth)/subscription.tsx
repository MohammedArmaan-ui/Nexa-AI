...
export default function SubscriptionScreen() {
  ...
  const renderedPlans = useMemo(() => plans.map(plan => (
    <View key={plan.id} style={styles.planCard}>
      ...
      {/*
          ⚡ Bolt Optimization: Consolidating multiple sibling Text components into
          a single Text component with newlines reduces the native Shadow Tree
          view count by (n - 1) per list.
          Impact: Reduced memory overhead and faster initial render for lists.
      */}
